...
class DataSet(object):
    ...
    def get_dataset(self, only_val=False):
        if not self.custom_class:
            ...
            if not only_val:
                train_set = folder.ImageFolder(root=train_path, transform=self.transform_train,
                                            label_mapping=self.label_mapping)
            test_set = folder.ImageFolder(root=test_path, transform=self.transform_test,
                                        label_mapping=self.label_mapping)
